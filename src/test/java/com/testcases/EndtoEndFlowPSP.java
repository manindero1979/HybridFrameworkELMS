...
public class EndtoEndFlowPSP extends BaseClass {
	...
	public void startAndActivateExamOfRegistrant() throws Exception {
		...
		pmicadmin.ActivateRecentlyCreatedPSPUser();
	 ...
	 */
	@Test (priority=11)
	public void loginPSPwithRecentlyCreatedStudent() throws Exception {
		log.info("************** Verifying Login Test *****************");
		Thread.sleep(3000);
		log.info("we are inside login method of PMIC admin");
		...
		lp.loginToPspStudent(registrant, pmicstudentpassword_data);
		Thread.sleep(5000);
