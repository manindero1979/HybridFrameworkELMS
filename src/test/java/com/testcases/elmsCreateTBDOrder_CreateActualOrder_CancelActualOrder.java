...
//engp-609
public class elmsCreateTBDOrder_CreateActualOrder_CancelActualOrder extends BaseClass {
	login_page lp = null;
	...
	@Test(priority = 6)
	public void openOrderAndCancelOrder() throws Exception {
		log.info("----------------Cancellation of Actual order will start-------------");
		beo.openActualOrderDetailspage();
		Thread.sleep(3000);	
		beo.clickCancelOrderLink();
		Thread.sleep(5000);
		beo.confirmOrderCancel();
		Thread.sleep(2000);
		beo.backToOriginalWindow();
		beo.refreshTBDOrder();	
		Thread.sleep(2000);
		beo.checkQtyOfCancelActualOrderAndtakeScreenshot();
	}
