...
//------------------------------
	...
	public void setCopyEventName() {
		log.info("I am inside setCopyEventName mthod");
		ename=ename+"-copy";
		event_name.sendKeys(ename);
		log.info("I have set copied event name");
	}
...
//Account for Onsite event
	...
	public WebElement btn_publishevent;
	...
	public void publishEvent() throws Exception {
		...
		log.info("EVENT PUBLISH BUTTON clicked");
		  Thread.sleep(20000);
			 ...
			 * FileUtils.copyFile(screenshot, new File("target/screenshots/eventcreated-" +
			 * ename + ".jpg")); log.info("screenshot captured"); } catch (IOException e) {
	...
	private WebElement copy_event;
	
	public void clickCopyEvent() {
		log.info("I am inside clickCopyEvent method");
		copy_event.click();
		log.info("copy event button clicked");
		}
	...
	public void clearAllFilterLink() {
		log.info("We are inside CLEAR ALL FILTER LINK method");
	...
	private WebElement btn_filterss;
	...
	public void setLaunchRegistrantItemQty(String qty) throws Exception {
		...
		Select select_quantity = new Select(select_launch_qty);
		select_quantity.selectByVisibleText(qty);
		log.info("Product item qty is selected");
		Thread.sleep(6000);
		btn_register.click();
	...
	public void selectAddtocartAndProceedToRegistration() throws Exception {
		...
		log.info("i am inside selectAddtocartAndProceedToRegistration method");
		Thread.sleep(4000);
...
{log.info("Disclaimer msg is not available for this product and registrant");}
	...
	public void clickProceedToCheckoutBtnAfterDC() throws Exception {
		log.info("I am in clickProceedToCheckoutBtn method");
		/*((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView();",
				label_promocode);*/
		Thread.sleep(7000);//updated on 8 aug 23
